...
function ExtensionsAndPolyfills(window, document, ZMBA){
   ...
   ZMBA.extendType(Element.prototype, { //For InternetExplorer and Edge
   ...
   ZMBA.extendType([NodeList.prototype, HTMLCollection.prototype, Array.prototype], { //both Polyfills and extensions
