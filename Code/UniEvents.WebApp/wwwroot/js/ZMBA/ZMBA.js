...
(function (window, document, extensionsAndPolyfills) {
   ...
   ZMBA.isAppleMobileDevice = /iPhone|iPad|iPod/i.test(navigator.userAgent);
   ZMBA.isOldiOS = ZMBA.isAppleMobileDevice && /Version\/7.0 Mobile|Version\/6.0 Mobile/.test(navigator.userAgent);
   ZMBA.isMobileDevice = ZMBA.isAppleMobileDevice || /android|webOS|BlackBerry|phone|mobile|mini|pocket|symbian|treo/i.test(navigator.userAgent);
   ...
   function ExtensionsAndPolyfills(window, document, extendType, ZMBA) {
