...
////Declare are input parameters for the IndexOfDelegate
//ParameterExpression thisParam = Expression.Parameter(typeSqlDataReader, "reader");
//ParameterExpression nameParam = Expression.Parameter(typeof(string), "name");
//NewExpression new_FieldNameLookup = Expression.New(FieldNameLookup_New, Expression.Convert(thisParam, typeof(IDataRecord)));
//Expression.Field(thisParam, SqlDataReader_getFieldNameLookup);
//ParameterExpression var_statistics = Expression.Variable(typeSqlStatistics);
//Expression.TryFinally(
//   //try {
//   Expression.Block(
//      //statistics = SqlStatistics.StartTimer(this.Statistics);
//      Expression.Assign(var_statistics, Expression.Call(SqlStatistics_StartTimer, Expression.Property(thisParam, SqlDataReader_GetStatistics))),
//      //if(this._fieldNameLookup == null) {
//         Expression.IfThen(Expression.Equal(Expression.Convert(Expression.Constant(null), typeFieldNameLookup), Expression.Field(thisParam, SqlDataReader_getFieldNameLookup)), Expression.Block(
//               //this.CheckMetaDataIsReady();
//               Expression.Call(thisParam, SqlDataReader_CheckMetaDataIsReady),
//               Expression.Field(thisParam, SqlDataReader_setFieldNameLookup, )
...
//      ),
//   //finally {
//   Expression.Call(SqlStatistics_StopTimer, var_statistics));
//   //}
